...
int rs::OpenComport(int comport_number, int baudrate)
{
  int baudr;
...
int rs::PollComport(int comport_number,  char *buf, int size)
{
  int n;
...
int rs::SendByte(int comport_number,  char byte)
{
  int n;
...
int rs::SendBuf(int comport_number, char *buf, int size)
{
  return(write(Cport[comport_number], buf, size));
}


void rs::CloseComport(int comport_number)
{
  close(Cport[comport_number]);
...
char comports[16][10]={"\\\\.\\COM56",  "\\\\.\\COM2",  "\\\\.\\COM3",  "\\\\.\\COM4",
                       "\\\\.\\COM5",  "\\\\.\\COM6",  "\\\\.\\COM7",  "\\\\.\\COM8",
...
int rs::IsCTSEnabled(int comport_number)
{
  int status;
...
void rs::cprintf(int comport_number, const char *text)  /* sends a string to serial port */
{
